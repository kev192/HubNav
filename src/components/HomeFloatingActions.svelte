  ...
  {#if isAuthenticated}
    ...
    >
      <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <path d="m19.4 13.5 1.1.8-1.8 3.1-1.3-.5a7.8 7.8 0 0 1-1.6.9l-.2 1.4h-3.6l-.2-1.4a7.8 7.8 0 0 1-1.6-.9l-1.3.5-1.8-3.1 1.1-.8a7.4 7.4 0 0 1 0-1.9l-1.1-.8 1.8-3.1 1.3.5a7.8 7.8 0 0 1 1.6-.9l.2-1.4h3.6l.2 1.4a7.8 7.8 0 0 1 1.6.9l1.3-.5 1.8 3.1-1.1.8a7.4 7.4 0 0 1 0 1.9Z" />
      </svg>
    </button>
    <button
      type="button"
